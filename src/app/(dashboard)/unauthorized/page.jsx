...
// Component that handles reading the search params
...
// Main Export Page wrapped in Suspense Boundary
export default function UnauthorizedPage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0a0705]">
      <Suspense
        fallback={
          <div className="bg-[#120c09] border border-red-500/10 rounded-2xl p-8 max-w-md w-full text-center space-y-4">
            <div className="w-10 h-10 border-2 border-red-500/20 border-t-red-500 rounded-full animate-spin mx-auto" />
            <p className="text-xs text-[#9CA3AF]">Checking status...</p>
          </div>
        }
      >
        <UnauthorizedContent />
